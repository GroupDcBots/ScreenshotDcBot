...
async def start(c, m):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Source 😒', url='https://github.com/selfie-bd/screenshotdcBot'),
                    InlineKeyboardButton('🔰 Project Channel 🔰', url='https://t.me/groupdcbots')
                ],
                [
                    InlineKeyboardButton('My Father 👤', url='https://t.me/selfiebd')
                ]
            ]
        )
    )
